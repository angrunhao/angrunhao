...
def init_callbacks(btzc_app, spotData, forwardData, ymax, ymin, colors, dateList):
    @btzc_app.callback([Output(component_id="date-output", component_property="children"),
...
btzc_app.layout = html.Div(children=[
    ...
    dcc.Slider(id="date-slider-input", min=0, max=len(dateList) - 1,
                value=0, step=1)])
#intialize callbacks
init_callbacks(btzc_app, spotData, forwardData,
